"""
Initialization module for OSC transformer-based extractor.

This module initializes the OSC transformer-based extractor package. It provides
functions and classes for extracting data using transformer-based models tailored
